...
const GenerationOne = () => {
  ...
  const hasLevel = (moves: any[]) =>
    moves.some(
      (move) =>
        (move.goldSilverLevel && move.goldSilverLevel !== "-") ||
        (move.crystalLevel && move.crystalLevel !== "-")
    );
        ...
        <TableBody>
          {moves.map((move) => (
            <TableRow key={move.moveName}>
              {showLevelColum && (
                <TableCell className="">
                  {move.goldSilverLevel || move.crystalLevel || ""}
                </TableCell>
              )}
  ...
  return (
    <Layout>
      <div className=" ">
        <div className="xl:w-full  xl:flex bg-red-300 xl:justify-center xl:items-center xl:flex-col xl:ml-">
          <div className="xl:w-9/12 xl:bg-white">
            <div className="iphoneSe:text-3xl md:text-5xl xs:text-2xl text-lg xs:flex-row px-3 samsungS8:text-2xl xl:text-5xl gap-1 flex samsungS8:flex-col justify-center items-center py-4 font-bold">
              {capitalize(pokemonName)} - Generation 2 <p>Learnset</p>
            </div>
            <div className="w-full lg:flex lg:flex-row lg:justify-center lg:w-11/12 lg:ml-12 xxl:ml-6 ">
              <div className="samsungS8:pl-10 lg:pl-0 lg:gap-4 lg:text-lg pixel7:mx-0 pixel7:w-full lg:pr-0  md:w-full md:pl-12 iphoneSe:w-96 iphoneSe:pl-4 xs:pl-8 samsungS8:w-full samsungS8:px-8 iphone12Pro:px-10 xl:ml-2">
                <div>
                  This page lists all the moves that {pokemonName} can learn in
                  Generation 2, which consists of these games:
                </div>
                ...
                <div className="xxl:pr-28">
                  ...
                  accuracy and other information listed below is as it was in
                  the respective games. Check a move's detail page for stats in
                  the most recent games and when they changed.
                </div>
              </div>
            ...
            <Tabs defaultValue="tab1">
              <TabsList className="samsungS8:ml-12 surfaceDuo:ml-10 iphoneSe:ml-4 md:ml-8 lg:ml-10 mt-4   ">
                <TabsTrigger value="tab1">Gold/Silver</TabsTrigger>
                <TabsTrigger value="tab2">Crystal</TabsTrigger>
              </TabsList>
              <TabsContent value="tab1">
                <div
                  className="lg:grid lg:grid-cols-6 pb-8  pixel7:w-80 xs:w-96 ml-4 xs:mx-20 iphone14:mx-4 w-80 gap-2 surfaceDuo:w-10/12 surfaceDuo:ml-10 iphoneSe:flex iphoneSe:flex-col samsungS8:w-72 samsungS8:ml-12 iphoneSe:ml-10 md:ml-0 md:w-full md:px-8 
              lg:ml-10 xl:ml-0 xl:w-full lg:px-0 "
                >
                  {/* <div className=" "> */}
                  <div className="lg:col-span-3 w-full    ">
                    <div className="xl:w-12/12 xl:ml-9">
                      ...
                      {pokemonMoveData?.goldSilver?.levelUp &&
                      pokemonMoveData.goldSilver.levelUp.length > 0 ? (
                        renderMoveTable(pokemonMoveData.goldSilver.levelUp)
                      ) : (
                    ...
                    <div className="xl:pl-10">
                      ...
                      <div className="py-2">
                        {pokemonMoveData?.goldSilver.egg &&
                        pokemonMoveData.goldSilver.egg.length > 0 ? (
                          renderMoveTable(pokemonMoveData.goldSilver.egg)
                        ) : (
                  ...
                  <div className="lg:col-span-3 lg:w-full  ">
                    <div className="xl:w-11/12 xl:mr-10">
                      <div className="text-lg font-bold pt-4 ">
                        Move learn by TM
                      </div>
                      <div className="py-2  ">
                      ...
                      {pokemonMoveData?.goldSilver.tm &&
                      pokemonMoveData.goldSilver.tm.length > 0 ? (
                        renderMoveTable(pokemonMoveData.goldSilver.tm)
                      ) : (
                        <div className="pt-2 pb-8">
              ...
              <TabsContent value="tab2">
                {/* CRYSTAL */}
                <div
                  className="lg:grid pb-8 lg:grid-cols-6 lg:w-full pixel7:w-80 xs:w-96 ml-4 xs:mx-20 iphone14:mx-4 w-80 gap-2 surfaceDuo:w-10/12 surfaceDuo:ml-10 iphoneSe:flex iphoneSe:flex-col
               samsungS8:w-72 samsungS8:ml-12 iphoneSe:ml-10 md:ml-0 md:w-full md:px-8 lg:ml-10 xl:w-full  xl:ml-0    "
                >
                  <div className="lg:col-span-3 pl-1 w-full">
                    <div className=" ">
                      <div className="text-lg font-bold pt-4">
                        Move learn by level up
                      </div>
                      ...
                      {pokemonMoveData?.crystal?.levelUp &&
                      pokemonMoveData.crystal.levelUp.length > 0 ? (
                        renderMoveTable(pokemonMoveData.crystal.levelUp)
                      ) : (
                        <div> This pokemon cannot learn move </div>
                      )}
                    </div>
                    <div className="xl:pl-1">
                      <div className="text-lg font-bold pt-4 pb-2">
                        Egg moves
                      </div>
                      <div>
                        {pokemonMoveData?.crystal.egg &&
                        pokemonMoveData.crystal.egg.length > 0 ? (
                          renderMoveTable(pokemonMoveData.crystal.egg)
                        ) : (
                          <div className="pt-2 pb-8">
                            This Pokemon cannot learn any moves by breeding
                          </div>
                  ...
                  <div className="lg:col-span-3 lg:w-full  xl:pr-2 ">
                    <div className=" ">
                      <div className="text-lg font-bold pt-4 ">
                        Move learn by TM
                      </div>
                      ...
                      {pokemonMoveData?.crystal.tm &&
                      pokemonMoveData.crystal.tm.length > 0 ? (
                        renderMoveTable(pokemonMoveData.crystal.tm)
                      ) : (
                        <div className="pt-2 pb-8">
                          This Pokemon cannot be taught any TM moves
                        </div>
