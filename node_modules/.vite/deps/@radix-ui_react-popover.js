...
import {
  ...
  useMergeRefs,
  zeroRightClassName
} from "./chunk-N7INOYDR.js";
import {
  useEscapeKeydown
} from "./chunk-T5P52EYK.js";
import {
  Primitive,
...
var Popover = (props) => {
  ...
  const [hasCustomAnchor, setHasCustomAnchor] = React9.useState(false);
  ...
  return (0, import_jsx_runtime4.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime4.jsx)(
    PopoverProvider,
    {
      ...
      hasCustomAnchor,
      onCustomAnchorAdd: React9.useCallback(() => setHasCustomAnchor(true), []),
      onCustomAnchorRemove: React9.useCallback(() => setHasCustomAnchor(false), []),
      modal,
      children
    }
  ) });
...
var PopoverAnchor = React9.forwardRef(
  (props, forwardedRef) => {
...
var PopoverTrigger = React9.forwardRef(
  (props, forwardedRef) => {
...
var PopoverContentModal = React9.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME, props.__scopePopover);
    const contentRef = React9.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const isRightClickOutsideRef = React9.useRef(false);
    React9.useEffect(() => {
...
var PopoverContentNonModal = React9.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME, props.__scopePopover);
...
var PopoverContentImpl = React9.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopover,
      trapFocus,
...
var PopoverClose = React9.forwardRef(
  (props, forwardedRef) => {
...
var PopoverArrow = React9.forwardRef(
  (props, forwardedRef) => {
